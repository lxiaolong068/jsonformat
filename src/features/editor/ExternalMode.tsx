...
const ExternalMode = () => {
  ...
  return (
    <StyledAlert>
      ...
      <Modal title="External Host of JsonFormat" opened={isOpen} onClose={closeModal} centered>
        <Group>
          ...
          <Text>
            ...
            <Anchor href="https://jsoncrack.com">JsonFormat</Anchor>. Your continued support is
            ...
            enhances your experience but also contributes to the ongoing development of JsonFormat.
          </Text>
        </Group>
